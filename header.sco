...
; replaced by new table lookup scheme - these are clarinet range
...
; without giUseRawADindex = 1 in the relevant instrument section in i1
...
; f400 upwards - reserved for instrument data tables derived from het analysis